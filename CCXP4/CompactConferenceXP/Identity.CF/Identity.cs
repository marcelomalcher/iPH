    ...
    public class Identity
    {
        ...
        public static string Identifier
        {
            get
            {
                ...
                /// $CompactConferenceXP:
                /// Verify this. When identifier is not set, what should be returned?                
                return "Unknown";

                /// $CompactConferenceXP:
                /// Removed reference to config file, GetIdentifierFromMessenger and GetIdentifierFromWindows. 
                /// Commented
                ...
                //// Third, use Windows Authentication instead of Messenger if the override is set
                //if ((setting = ConfigurationManager.AppSettings[AppConfig.ID_WindowsAuth]) != null)
                //{
                //    return GetIdentifierFromWindows();
                //}

                //// Finally, use Messenger's email as the identifier if present, or fall back to Windows Authentication if not
                //return GetIdentifierFromMessenger();
            }
            set
            {
                identifier = value;
        ...
        /// $CompactConferenceXP:
        /// Removed reference to MessengerAPI. Then, there is no way to get the identifier from Messenger.
        /// Commented
        ...
        /// $CompactConferenceXP:
        /// Removed reference to Windows Authentication. There is no way to get the identifier from Windows at WinCE.
        /// Commented
