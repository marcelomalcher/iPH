...
/// $CompactConferenceXP:
/// Adding reference to OpenNETCF.Diagnostics for EventLog
...
/// $CompactConferenceXP:
/// Replaced all reference from Screen.PrimaryScreen.WorkingArea to Screen.PrimaryScreen.WorkingArea
...
namespace CF.MSR.LST.ConferenceXP
{
    ...
    public abstract class Conference
    {
        ...
        {
            /// $CompactConferenceXP:
            /// There is no support for installation
            /// Commented all
            //CheckInstalled();
        ...
        public static void FormInvoke(Delegate del, object[] args)
        {
            ...
            else
            {
                ...
                /// $CompactConferenceXP:
                /// System.Delegate does not contain a definition for DynamicInvoke
        ...
        private static string GetAssemblyDescription(Assembly a)
        {
            ///<summary>
            /// $CompactConferenceXP:
            /// System.Reflection.Assembly does not contain a definition for Location
        ...
        {
            /// $CompactConferenceXP:
            /// There is no reference to ConfigurationManager
            /*
        ...
        private static ICapabilityViewer CreateCapabilityForRtpStream(MSR.LST.Net.Rtp.RtpStream rtpStream)
        {
            ...
            /// $CompactConferenceXP:
            /// No overload for method CreateInstance takes 2 arguments
            /// Commented
            /*
            ...
            object[] objs = new object[] { Capability.DynaPropsFromRtpStream(rtpStream) };
            ...
            ConstructorInfo ci = (capabilityViewerClasses[payloadType]).GetConstructor(types);

            object obj = ci.Invoke(objs);

            return (ICapabilityViewer)obj;
        }
        ...
        {
            /// $CompactConferenceXP:
            /// There is no referente to ConfigurationManager
            /// Removed all 
            /*           
        ...
        private static void autoPositionCV(ICapability cv)
        {
            ...
            if (!capabilityForms.Contains(id))
            {
                if (cv is ICapabilityWindow)
                {
                    ...
                    int workingTop = Screen.PrimaryScreen.WorkingArea.Top;
                    int workingLeft = Screen.PrimaryScreen.WorkingArea.Left;
                    int workingBottom = Screen.PrimaryScreen.WorkingArea.Bottom;
                    int workingRight = Screen.PrimaryScreen.WorkingArea.Right;
        ...
        private static void autoSizeCapabilityWindow(ICapabilityWindow iCW)
        {
            ...
            {
                iCW.Size = new System.Drawing.Size(Screen.PrimaryScreen.WorkingArea.Width / 2, Screen.PrimaryScreen.WorkingArea.Height / 2);
            }

            if (autoPosition == AutoPositionMode.FullScreen)
            {
                iCW.Height = Screen.PrimaryScreen.WorkingArea.Height;
                iCW.Width = Screen.PrimaryScreen.WorkingArea.Width;
                iCW.Left = Screen.PrimaryScreen.WorkingArea.Left;
                iCW.Top = Screen.PrimaryScreen.WorkingArea.Top;
                return;
            }
        }
