...
using CF.MSR.LST;
using CF.MSR.LST.Net;
using CF.MSR.LST.Net.Rtp;

//Pri2: Move TTL to the Venue definition and inside VenueData

/// $CompactConferenceXP:
/// Adding reference to CCXP.Utils.Collections for DictionaryBase
using CCXP.Utils.Collections;
...
/// $CompactConferenceXP:
/// Added reference to CompactFormatter.Interfaces for ICSerializable Interface
using CompactFormatter.Interfaces;

/// $CompactConferenceXP:
/// Added reference to CompactFormatter.Exception for SerializationException
...
namespace CF.MSR.LST.ConferenceXP
{
    ...
    public class Venue : IVenue
    {
        ...
        /*
        /// <summary>
        /// Current list of Participants in the Venue.  Will be empty unless the Venue is Joined.
        /// </summary>
        public IParticipant[] Participants
        {
            get
            {
                ArrayList al = new ArrayList(venueParticipants.Values);
                return (IParticipant[])al.ToArray(typeof(IParticipant));
            }
        }
        /// <summary>
        /// Current list of CapabilityViewer capable to be displayed in the Venue.  A CapabilityViewer is the viewing object created for each stream
        /// of data sent by a Participant.  Will be empty unless the Venue is Joined.
        /// </summary>
        public ICapabilityViewer[] CapabilityViewers
        {
            get
            {
                ArrayList al = new ArrayList(Conference.capabilityViewers.Values);
                return (ICapabilityViewer[])al.ToArray(typeof(ICapabilityViewer));
            }
        }
        */
    ...
    public class VenueList : ICollection, IEnumerable, ICSerializable, ICloneable
    {
        ...
        //    }
        //}
        public VenueList(CompactFormatter.CompactFormatter parent, System.IO.Stream stream)
        {
        ...
        /// $CompactConferenceXP:
        /// There is no more ISerializable implementation
        /// Commented all
        /*
        ...
        */
        ...
        public void ReceiveObjectData(CompactFormatter.CompactFormatter parent, System.IO.Stream stream)
        {
            ...
            venues = (Venue[])parent.Deserialize(stream);
        ...
        {
            Venue[] venues = (Venue[])arrayList.ToArray(typeof(Venue));
            parent.Serialize(stream, venues); 
        }
