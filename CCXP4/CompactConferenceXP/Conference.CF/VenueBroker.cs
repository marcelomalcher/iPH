...
using CF.MSR.LST.ConferenceXP.VenueService;
...
namespace CF.MSR.LST.ConferenceXP
{
    ...
    public class VenueBroker
    {
        ...
        private string versionError = null; // stores any error message for bad assembly versions
        ...
        private void RefreshVenues()
        {
            ...
            try
            {
                ...
                /// $CompactConferenceXP:
                /// The type or namespace name 'FileVersionInfo' does not exist in the namespce 'System.Diagnostics'...
