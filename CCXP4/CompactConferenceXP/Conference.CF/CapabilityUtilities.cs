...
namespace CF.MSR.LST.ConferenceXP
{
    ...
    public class CapabilityUtilities
    {
                                                       ...
                                                       out CapabilitySenderClassHashtable capabilitySenderClasses)
        {
            ...
            /// $CompactConferenceXP:
            /// There is no referente to Assembly.GetEntryAssembly
            ...
            foreach (FileInfo fiDll in fis)
            {
                try
                {
                    ...
                    foreach (Type type in types)
                    {
                        ...
                        /// $CompactConferenceXP:
                        /// GetInterface replaced.
                        /// > Type iCV = type.GetInterface("MSR.LST.ConferenceXP.ICapabilityViewer");                       
                        Type iCV = Assembly.Load("ConferenceXPInterfaces").GetType("MSR.LST.ConferenceXP.ICapabilityViewer");
                ...
                /// $CompactConferenceXP:
                /// Compact Framework does not support these exceptions
            ...
            CapabilitySenderClassHashtable capabilitySenderClasses)
        {
            try
            {
                ...
                else
                {
                    ...
                    MessageBox.Show(msg, "Error Initializing Capability Classes", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1);
                }
            }
            catch (Exception e)
            {
                ...
                MessageBox.Show("Accessing file " + fileName + "\n" +
                    e.ToString(), "Error Initializing Capability Sender", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1);
            }
        }
