...
/// $CompactConferenceXP:
/// Adding reference to OpneNETCF.Diagnostics for EventLogEntryType enum
using OpenNETCF.Diagnostics;

/// $CompactConferenceXP:
/// Adding reference to CCXP.Utils.Performance for PerformanceCounter class.
using CCXP.Utils.Performance;
...
namespace CF.MSR.LST
{
    ...
    public abstract class BasePCInstaller
    {
        ...
        /// $CompactConferenceXP:
        /// Removed all install/uninstall method. Compact Framework does not support Install
        /// Commented all       
    ...
    public abstract class BasePC
    {
        ...
        */
        ...
        private void UniquifyInstanceName(ref string instanceName)
        {
            ...
            /// $CompactConferenceXP:
            /// There is no PerformanceCounterCategory. Removed all. 
            ...
            */
            ...
            {
                int i = 0;
                while (InstanceExists(instanceName + "_" + (++i))) ;
        ...
        /// $CompactConferenceXP:
        /// There is no PerformanceCounterCategory.  
        ...
        private bool InstanceExists(string instanceName)
        {
            ...
            if (pcs == null)
                return exists;
            foreach (PerformanceCounterWrapper pcw in pcs)
            {
                if (pcw.InstanceName.Equals(instanceName))
                {
                    exists = true;
                    break;
                }
