        ...
        public static IPAddress GetLocalRoutingInterface(IPAddress ipAddress)
        {
            ...
            if (ipAddress.AddressFamily == AddressFamily.InterNetwork)
            {
                ...
                try
                {
                    ...
                    /// $CompactConferenceXP:
                    /// Marshal.StructureToPtr for .NET CF only works with third parameter equals to false
                ...
                catch (SocketException se)
                {
                    ...
                    /// $CompactConferenceXP:
                    /// There isn't EventLog at WindowsCE/.NET CompactFramework.
            ...
            /// $CompactConferenceXP:
            /// There isn't Socket.OSSupportsIPv6
            /// Removed
