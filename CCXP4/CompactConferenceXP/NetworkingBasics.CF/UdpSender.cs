...
using System.Net;
using CF.MSR.LST.Net.Sockets;
using System.Net.Sockets;
using LstSocks = CF.MSR.LST.Net.Sockets;
    ...
    public class UdpSender : INetworkSender
    {
        ...
        public UdpSender(System.Net.IPEndPoint endPoint, ushort timeToLive)
        {
            ...
            if (Utility.IsMulticast(endPoint.Address))
            {
                ...
                /// $CompactConferenceXP:
                /// Removed because Compact Framework does not support MulticastLoopback
                /// Commented                
        ...
        public short DelayBetweenPackets
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("DelayBetweenPackets must be in the range of 0 to 30");
                }
