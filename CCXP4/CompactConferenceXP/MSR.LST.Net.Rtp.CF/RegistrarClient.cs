...
using CF.ReflectorCommonLib; // used to get the definition of a Message class.
using CF.MSR.LST.Net.Rtp;
using CF.MSR.LST;

/// $CompactConferenceXP:
/// Compact Framework does not supports binary formatter
/// Commented
//using System.Runtime.Serialization.Formatters.Binary; // Used to send an object over network

/// $CompactConferenceXP:
/// Added Reference to CompactFormatter for serialization
using CompactFormatter;

namespace CF.ReflectorRegistrarClient
{
    /// <summary>
    ...
    public class RegistrarClient
    {
        ...
        public int join(IPAddress groupIP, int groupPort)
        {
            ...
            {
                /// $CompactConferenceXP:
                /// There is System.Diagnostics.EventLogEntryType in Compact Framwork
