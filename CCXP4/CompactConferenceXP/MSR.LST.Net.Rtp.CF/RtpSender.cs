...
namespace CF.MSR.LST.Net.Rtp
{
    ...
    public class RtpSender
    {
        ...
        internal RtpSender(IRtpSession rtpSession, string name, PayloadType payloadType, Hashtable priExns)
        {
        ...
        public void Dispose()
        {
            ...
            {
                LogEvent("Error while disposing RtpSender: " + e.ToString(),
        ...
        public void Send(IntPtr[] ptrs, int[] lengths, bool prependLengths)
        {
            ...
            if (ptrs.Length != lengths.Length)
                throw new ArgumentException("Array sizes must agree");

            if (ptrs.Length == 0)
                throw new ArgumentException("There must be at least one IntPtr of data to send");
        ...
        {
            if (disposed) throw new ObjectDisposedException("RtpSender already disposed");
        ...
        public short DelayBetweenPackets
        {
            ...
            set
            {
                ...
                sdes.SetPrivateExtension(Rtcp.PEP_DBP, value.ToString());
            }
        }
