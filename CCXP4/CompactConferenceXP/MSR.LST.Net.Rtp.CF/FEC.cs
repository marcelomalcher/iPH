...
namespace CF.MSR.LST.Net.Rtp
{
    ...
    public class XOR_Fec : IFec
    {
        ...
        private void ValidateNullData(BufferChunk[] data, int expectedNullCount)
        {
            ...
            {
                throw new ArgumentException(string.Format("Incorrect number of null objects, " +
                    "expected:{0}, actual:{1}", expectedNullCount, actualNullCount));
            }
        }
        ...
        private void ValidateChecksumPacketCount(int nbChecksumPackets)
        {
            if (nbChecksumPackets != 1)
            {
                ...
                throw new ArgumentOutOfRangeException("nbChecksumPackets = " + nbChecksumPackets.ToString(), "XOR can only produce 1 checksum packet");
            }
        }
        ...
        private void ValidateObjectNotNull(object data)
        {
            if (data == null)
            {
                throw new ArgumentNullException("data", "Null objects are not accepted");
            }
        }
    }
