...
namespace CF.MSR.LST.Net.Rtp
{
    ...
    public class RtpStream
    {
        ...
        public override string ToString()
        {
            ...
            return string.Format("RtpStream [ ssrc := {0}, name := {1}, PayloadType := {2} ]", ssrc, name, pt.ToString());
        }
        ...
        public BufferChunk NextFrame()
        {
            ...
            if (nextFrameUnblocked)
            {
                ...
                throw new NextFrameUnblockedException(
                    "NextFrame call has been unblocked, either manually or by the Dispose method");
            }
        ...
        private void ValidateUsingNextFrame()
        {
            if (!isUsingNextFrame)
            {
                string msg = "Calling a NextFrame method without first calling IsUsingNextFrame = true";
    ...
    internal abstract class RtpStreamFec : RtpStream
    {
        ...
        protected void ValidatePayloadType(PayloadType pt)
        {
            ...
            {
                throw new ArgumentException("Unexpected payload type!");
            }
        }
