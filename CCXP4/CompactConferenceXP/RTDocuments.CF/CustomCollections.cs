...
/// $CompactConferenceXP:
/// Added reference to CCXP.Utils for DictionaryBase class
...
namespace CF.MSR.LST.RTDocuments
{
    ...
    public class TOCList : ICollection, IEnumerable, ICSerializable, ICloneable
    {
        ...
        */
        public TOCList(CompactFormatter.CompactFormatter parent, System.IO.Stream stream)
        {
        ...
        */
        ...
        public void ReceiveObjectData(CompactFormatter.CompactFormatter parent, System.IO.Stream stream)
        {
            ...
            tocNodes = (TOCNode[])parent.Deserialize(stream);
