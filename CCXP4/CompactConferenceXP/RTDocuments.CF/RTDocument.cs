...
namespace CF.MSR.LST.RTDocuments
{
    ...
    public class RTDocument : ICloneable
    {
        ...
        {
            return "RTDocument " +
                "{ RTDocument.Identifier: " + identifier.ToString() +
                ", Metadata.Title: " + Metadata.Title +
                ", Organization.TableOfContents.Count: " + Organization.TableOfContents.Count +
                ", Resources.Pages.Count: " + Resources.Pages.Count +
                ", Resources.ResourceList.Count: " + Resources.ResourceList.Count +
                " }";
        }
    }
    ...
    public class Organization : ICloneable
    {
        ...
        {
            return "Organization " +
                "{ TableOfContents.Count: " + TableOfContents.Count +
                " }";
        }
    }
    ...
    public class TOCNode : ICloneable
    {
        ...
        public override string ToString()
        {
            return "TOCNode " +
                ...
                ", ResourceIdentifier: " + ResourceIdentifier.ToString() +
                ", Title: " + Title +
    ...
    public class Resource : ICloneable
    {
        ...
        /// $CompactConferenceXP:
        /// Not using ResourceType. There is no need to serialize this.
        [NotSerialized]
    ...
    public class Page : ICloneable
    {
        public Guid Identifier;
        /// <summary>
        /// Supported mimetimes are image/png and image/x-wmf.  Other image/* could go here in future
        /// </summary>
        public string MimeType;
        /// <summary>
        ...
        object ICloneable.Clone()
        {
            ...
            /*if (Regions != null)
            {
                clone.Regions = (Region[])Regions.Clone();
            }
            if (PrivateNotes != null)
            {
                if (PrivateNotes is ICloneable)
                {
                    clone.PrivateNotes = ((ICloneable)PrivateNotes).Clone();
                }
            }
            if (PublicNotes != null)
            {
                if (PublicNotes is ICloneable)
                {
                    clone.PublicNotes = ((ICloneable)PublicNotes).Clone();
                }
            }*/
    ...
    {
        /// $CompactConferenceXP:
        /// Removed invokes that uses Gdi32.dll
        /// Commented all
        //
        // P/Invokes
        //
        ...
        */ 
        ...
        ///     }
        ///   }
        RTImage(CompactFormatter.CompactFormatter parent, Stream stream)
        {
        ...
        */
        ...
        {
            byte[] bits = (byte[])parent.Deserialize(stream);
            MemoryStream ms = new MemoryStream(bits);
            image = new Bitmap(ms);
        }
    ...
    /* Region is not currently under development for
    /// <summary>
    /// See the Presenter work by Richard Anderson and Steve Wolfman from UWashington.
    /// </summary>
    [Serializable]
    public class Region : ICloneable
    {
        ...
        object ICloneable.Clone()
        {
            ...
            if (Children != null)
            {
                clone.Children = (Region[])Children.Clone();
            }
    ...
    */
    ...
    /// $CompactConferenceXP:
    /// Removed attribute Serializable for enum
    //[Serializable]
