...
namespace LAC.Communications
{
    public class CommunicationControl
    {
        ...
        private ICommunications myCommunicationsObject;
        ...
        public CommunicationControl(ICommunications theCommunicationsObj)
            : base()
        {
            this.CommObject = theCommunicationsObj;
        ...
        public ICommunications CommObject
        {
            get 
            { 
                return this.myCommunicationsObject; 
            }
            set
            {
                if (value != null)
                    this.myCommunicationsObject = value;
            }
        }
        ...
        // verify performance
        public bool Connect(string ipAddressString, ushort portNumber, ushort ttl, String connectionName, ushort fecPerc)
        {
        ...
        {           
            ...
            try
            {
                ...
                /*
                 * MessageBox.Show("Received: " + obj.GetType().Name);
