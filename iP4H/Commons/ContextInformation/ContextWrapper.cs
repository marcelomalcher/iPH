...
using System.Text;
using LAC.ContextInformation.MocaWebService;

namespace LAC.ContextInformation
{
    /// <summary>
    ...
    public class ContextWrapper
    {
        ...
        #region Context Access Sync Methods
        ...
        #region Context Access Async Methods

        public DeviceContext RequestDeviceContext(string macAddress, string conditionSQL, long timeOut)
        {
            try
            {
                MocaWebService.deviceContextWS dvcContext = mocaWS.requestCIS(macAddress, conditionSQL, timeOut);
                if (dvcContext == null)
                    return null;
                DeviceContext deviceContext = new DeviceContext(dvcContext);
                return deviceContext;
