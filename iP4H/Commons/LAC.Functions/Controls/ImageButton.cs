...
namespace LAC.Functions.Controls
{
    ...
    public class ImageButton : Control
    {
        ...
        private Color cSelected = Color.AntiqueWhite;
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            {
                if (bSelected)
                    backBrush = new SolidBrush(cSelected);
                else
            ...
            if ((bPushed) || (bSelected)) //The button was pressed
            {
                //Prepare rectangle
